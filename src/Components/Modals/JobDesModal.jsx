...
const JobDesModal = ({ datas, setData, open, close }) => {
  const closeModal = () => {
        ...
        <div className="w-[59rem] h-[60rem] bg-white rounded-[1.875rem] shadow-md relative">
          ...
          <div className="flex flex-row gap-6 mt-8">
            ...
            <span className="flex flex-row gap-2 ml-2">
              <span className="text-black text-xs font-semibold font-Outfit  border-2 border-dotted border-black border-opacity-50 w-5 h-5 flex justify-center rounded-full mr-[8rem]">
                2
              </span>
            </span>
            <span className="flex flex-row gap-2">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid justify-center mt-[2.56rem]">
              ...
              <span className="flex flex-row justify-start">
                <p className="text-black text-base font-semibold font-Poppins mt-[0.3rem]">
                  Skill Required
                </p>
              ...
              <input className="w-[45.68rem] h-12 bg-gray-100 rounded-lg p-2"{...register("skill_required")}/>
              ...
              className="w-[45.68rem] h-[10.68rem]  bg-gray-100 rounded-lg">
